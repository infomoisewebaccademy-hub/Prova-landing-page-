            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="pt-8">
                        ...
                        <h2 className="text-4xl md:text-5xl font-semibold text-white mb-8 tracking-tight leading-tight">
                            {preTitle}
                            <span className="text-brand-400 block mt-2">{brandTitle}</span>
                        </h2>
                        
                        <div className="text-slate-300 text-lg leading-relaxed mb-8 space-y-4">
                           <p>{config.about_section.text.split("\n\n")[0]}</p> 
                           {config.about_section.text.includes("fastidio") && (
                               <p className="border-l-2 border-slate-700 pl-4 italic text-slate-400">
                                   Nel mercato della formazione c'è una cosa che ci ha sempre dato fastidio:
                               </p>
                           )}
                        </div>
